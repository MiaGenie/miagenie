...
<template>
    <div
        :class="{
            'border-primary-200 ring ring-primary-200 ring-opacity-50': focused,
        }"
    ...
    >
        ...
        >
            <Dropdown width-classes="w-40" placement="bottom-start">
                <template #trigger>
                    <button type="button" class="w-28 text-left h-full">
                        {{ activeFormat }}
                    </button>
                </template>
        ...
        <editor-content
            :editor="editor"
            class="editor-classic-format max-h-96 overflow-y-auto p-xs"
        />
    </div>
</template>
