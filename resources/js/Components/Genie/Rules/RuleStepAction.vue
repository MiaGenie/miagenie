...
const getRoute = (name) => {
    switch (name) {
        case 'create':
            return route('genie.admin.versions.rules.groups.steps.create', {
                rule: props.rule.id,
            });
        case 'edit':
            return route('genie.admin.versions.rules.groups.steps.edit', {
                rule: props.rule.id,
                step: props.itemId,
            });
        case 'delete':
            return route('genie.admin.versions.rules.groups.steps.delete', {
                rule: props.rule.id,
