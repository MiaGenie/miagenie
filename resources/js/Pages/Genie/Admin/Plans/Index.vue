...
import PlanItemTranslate from "@/Components/Genie/Plans/PlanItemTranslate.vue";
...
<template>
    ...
    <Head :title="$t('genie.payment_plans')"/>

    <div class="w-full mx-auto row-py">

        <PageHeader :title="$t('genie.payment_plans')" />
            ...
            >
                ...
                <Table>
                    ...
                    <template #body>
                        ...
                        <template v-for="plan in records.data">

                            <PlanItemTranslate :plan="plan"/>
