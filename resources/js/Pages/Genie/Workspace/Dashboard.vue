...
import DashboardButtons from "@/Components/Genie/Dashboard/DashboardButtons.vue";
import DashboardPosts from "@/Components/Genie/Dashboard/DashboardPosts.vue";
...
<template>
    ...
    <div class="row-py">
        ...
        <div class="row-px my-2xl">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-sm">
                <DashboardPosts :posts="posts_pending_review" :title="$t('genie.pending_review')" />
                <DashboardPosts type="scheduled" :posts="posts_scheduled" :title="$t('genie.next_posts')" />
            </div>
        </div>

        <PageHeader :title="$t('genie.analytics')" />

        <div class="row-px flex items-end justify-end row-mb">
