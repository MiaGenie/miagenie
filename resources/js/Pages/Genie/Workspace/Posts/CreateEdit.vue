...
const props = defineProps(['post', 'schedule_at', 'accounts', 'prefill', 'draft']);
                    ...
                    <div class="row-py h-full overflow-y-auto">
                        ...
                        <div class="w-full m-container mx-auto row-px">
                            ...
                            <Panel v-if="draft" class="mt-xl">
                                ...
                                <VerticalGroup>
                                    <template #title>{{  $t('genie.media_instructions')  }}</template>

                                    <div class="whitespace-pre-wrap text-base">{{  draft.media  }}</div>
