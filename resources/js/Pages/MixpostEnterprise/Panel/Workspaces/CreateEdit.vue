...
const store = () => {
    getTransformedForm().post(route(`mixpost_e.workspaces.store`))
}

const update = () => {
    getTransformedForm().put(route(`mixpost_e.workspaces.update`, {'workspace': props.workspace.uuid}), {
        onSuccess: () => {
...
<template>
        ...
        <div class="row-px">
            <form method="post" @submit.prevent="submit">
                <Panel>
                    ...
                    <HorizontalGroup>
                        <template #title>
                            <label for="name">{{ $t('enterprise-general.name') }}
                    ...
                    <HorizontalGroup class="mt-lg">
                        <template #title>
                            <label for="locale">{{ $t('genie.language') }}
                                <LabelSuffix danger>*</LabelSuffix>
                            </label>
                        </template>
                    ...
                    <HorizontalGroup class="mt-lg">
                        <template #title>
                            <label for="version">{{ $t('genie.version') }}
                                <LabelSuffix danger>*</LabelSuffix>
                            </label>
                        </template>
                ...
                <PrimaryButton type="submit"
                    ...
                    {{ isCreate ? $t('enterprise-general.create') : $t('enterprise-workspace.update') }}
                </PrimaryButton>
            </form>
        </div>
    </div>
    ...
    <DialogModal :show="changeColorModal" max-width="md" @close="changeColorModal = false">
        ...
        <template #footer>
            ...
            <PrimaryButton @click="selectColor">{{ $t('enterprise-general.done') }}</PrimaryButton>
        </template>
    </DialogModal>
</template>
