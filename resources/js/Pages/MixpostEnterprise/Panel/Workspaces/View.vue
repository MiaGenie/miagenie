...
const redirectToPortal = () => {
    router.put(
        route(`${routePrefix}.workspaces.portalPaymentPlatform`, {
                ...
                <div class="md:max-w-(--container-2xl)">
                    ...
                    <HorizontalGroup class="mt-lg">
                        ...
                        >
                            {{
                                $t(
                                    "enterprise-subscription.requires_subscription",
                                )
                            }}
                        </div>
                        <div
                    ...
                    <HorizontalGroup class="mt-lg">
                        ...
                        <div
                            :style="{ background: workspace.hex_color }"
            ...
            <template v-if="subscription">
                <Panel class="mt-lg">
                    ...
                    <PrimaryButton
                        ...
                        :class="workspace.payment_method.type ? 'mt-lg' : ''"
                    >
