...
import useSubscription from "@meJs/Composables/useSubscription";
...
<template>
    <Panel>
        <template #title> {{ $t('enterprise-subscription.subscription') }}</template>
        ...
        <Flex>
            ...
            <template v-if="workspace.generic_subscription">
                <DangerButton
                    ...
                    {{ $t('enterprise-subscription.remove_generic_subscription') }}
                </DangerButton>
            </template>
        </Flex>
    </Panel>
    ...
    <DialogModal :show="changePlanModal"
        ...
        <template #header> {{ $t('enterprise-subscription.change_plan') }}</template>
    ...
    <DialogModal :show="infoModal"
        ...
        <template #header>{{ $t('enterprise-subscription.debug_sub_information') }}</template>
