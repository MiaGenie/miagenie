...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | A Genie run is one conversation, so its steps are prompted with what the
    | earlier steps produced. Titles are set from the run itself rather than
    | generated, which avoids an extra model call per run.
    |
    */
